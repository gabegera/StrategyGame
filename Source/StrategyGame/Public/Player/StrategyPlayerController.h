...
UCLASS()
class STRATEGYGAME_API AStrategyPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	bool bPrintDebugInfo = true;

	UPROPERTY(EditAnywhere, Category="Debug", meta=(EditCondition = bPrintDebugInfo))
	bool bPrintPlayerDebug = true;

	UPROPERTY(EditAnywhere, Category="Debug", meta=(EditCondition = bPrintDebugInfo))
	bool bPrintTimeDebug = true;

	UPROPERTY(EditAnywhere, Category="Debug", meta=(EditCondition = bPrintDebugInfo))
	bool bPrintPopulationDebug = true;

	UPROPERTY(EditAnywhere, Category="Debug", meta=(EditCondition = bPrintDebugInfo))
	bool bPrintResourcesDebug = true;

	UPROPERTY(EditAnywhere, Category="Debug", meta=(EditCondition = bPrintDebugInfo))
	bool bPrintUpgradesDebug = true;
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Getters")
	ARTSCamera* GetRTSCamera() const;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="Getters")
	EControllerMode GetControllerMode() const;
